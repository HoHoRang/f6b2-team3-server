                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <strong
                                    >안녕하세요. ${name} 후원자님!<br />Voluntier입니다
                                    :)</strong
                                  >
                                </h1>
                              </td>
                                  ...
                                  >
                                    <span
                                      style="
                                        ...
                                        line-height: 30.4px;
                                      "
                                      >Voluntier🐶😸 는 유기동물을 위한 </span
                                    ><span
                                      style="
                                        font-size: 16px;
                                        line-height: 30.4px;
                                      "
                                      >봉사와 후원을 위한 플랫폼이에요.</span
                                    >
                                  </p>
                                  <p
                                    dir="ltr"
                                  ...
                                  >
                                    <span
                                      style="
                                        ...
                                        line-height: 30.4px;
                                      "
                                      >${name}님의 후원으로, 우리가 배부르게
                                      먹고 따뜻하게 잘 수 있었어요!</span
                                    >
                                  </p>
                                  <p
                                    dir="ltr"
                                  ...
                                  >
                                    <span
                                      style="
                                        ...
                                        line-height: 30.4px;
                                      "
                                      >지난 <strong>${lastMonth}월</strong>에는,
                                      <strong>${amount}원</strong> 만큼
                                      후원해주셨어요!</span
                                    >
                                  </p>
                                </div>
